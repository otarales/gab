        ...
        <div class="banner-text text-center">
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-xs-12">
                        <!-- Title Starts -->
                        <h2 class="title-head" style="color: #fff;">Get in <span>touch</span></h2>
                        <!-- Title Ends -->
                        <hr>
                        <!-- Breadcrumb Starts -->
                        <ul class="breadcrumb">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-md-8 contact-form">
                ...
                <!-- Contact Form Starts -->
                <form id="contact" class="form-contact" method="post" action="">
                    <div id="messages"></div>
                    <br>
                    <!-- Input Field Starts -->
                        ...
                        <!-- Contact Info Box Ends -->
                            ...
                            <div class="contact-info-box">
                                ...
                                <div class="contact-info-box-content">
                                    ...
                                    <p>291 Indian Fls S Montgomery, Texas(TX), 77316, United States
                                    </p>
                                    <p>Phone: <a href="tel:+19199129791">+1 (919) 912-9791</a></p>
                                </div> +19199129791
                                <!-- Contact Info Box Starts -->
                                <div class="contact-info-box">
                                    ...
                                    <div class="contact-info-box-content">
                                        ...
                                        <p>
                                            <a href="mailto:support@TradeBtc.com">support@Tradetc.com</a>
                                        </p>
                                    </div>
